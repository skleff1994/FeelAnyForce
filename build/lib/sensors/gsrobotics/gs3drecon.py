...
class Visualize3D:
    def __init__(self, n, m, save_path, mmpp, window_name='3D Visualization'):
        self.n, self.m = n, m
    ...
    def init_open3D(self):
        ...
        self.vis.create_window(self.window_name, width=1280, height=960)
        ...
        camera_params.extrinsic = np.array([[7.82340462e-01, 6.18906713e-01, -6.99848662e-02, -2.13950038e+02],
                                            [2.37137065e-01, -3.99872764e-01, -8.85363081e-01, -4.53574859e+00],
                                            [-5.75942196e-01, 6.76059356e-01, -4.59602364e-01, 3.75400478e+02],
    ...
    def update(self, Z, tactile=None, bg=None):
        background = np.array(bg)
        tactile = tactile - background + 127
        self.depth2points(Z)
        dx, dy = np.gradient(Z)
        dx, dy = dx * 0.5, dy * 0.5
        ...
        tactile = tactile.reshape(self.points.shape) / 255
        self.pcd.colors = open3d.utility.Vector3dVector(tactile)
